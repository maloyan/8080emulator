...
int Emulate8080Op(State8080* state)
{
    ...
    switch (*opcode)
    {
        ...
        case 0xb0: state->a = state->a | state->b; LogicFlagsA(state);  break; //ORA B
        case 0xb1: state->a = state->a | state->c; LogicFlagsA(state);  break; //ORA C
        case 0xb2: state->a = state->a | state->d; LogicFlagsA(state);  break; //ORA D
        case 0xb3: state->a = state->a | state->e; LogicFlagsA(state);  break; //ORA E
...
int main (int argc, char**argv)
{
    ...
    ReadFileIntoMemoryAt(state, "cpudiag.bin", 0);
